...
export default function Home() {
  return (
    <div >
      <Head>
        ...
        <meta name="description" content="Delhi Fashion Emporium - we create your dream clothes"/>
      </Head>
      
      <img src="https://siyaram-images.s3.ap-south-1.amazonaws.com/images/banner/siyarams.webp" className="w-full"  alt="cover image"/>
      <main
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Fashion For Entire Delhi</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Choose your designs</p>
    </div>
    <div className="flex flex-wrap -m-4">
      ...
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-200 p-6 rounded-lg">
          <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-black-100 text-black mb-4">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
