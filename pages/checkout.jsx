  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      {cart.map((item)=>{return(
        <div class="flex flex-col rounded-lg bg-white sm:flex-row" key={item.id}>
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src={item.img} alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">{item.title}</span>
          <span class="float-right text-gray-400">{item.size}</span>
  ...
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div class="">
      ...
      <div class="mt-6 border-t border-b py-2">
        ...
        <div class="flex items-center justify-between">
          <p class="text-sm font-medium text-gray-900">Savings (10% off)</p>
          <p class="font-semibold text-gray-900"> -${(0.1*subTotal).toFixed(2)}</p>
        </div>
        <div class="flex items-center justify-between">
      ...
      <div class="mt-6 flex items-center justify-between">
        ...
        <p class="text-2xl font-semibold text-gray-900">${(subTotal + (-0.1*subTotal) + 50)}</p>
      </div>
    </div>
