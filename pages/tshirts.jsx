      ...
      <div className="md:m-16">
        <div className="grid gap-4 mx-auto  grid-cols-2 md:grid-cols-5 ">
          {Object.keys(tshirts)?.map((item) => {
            return (
              <div key={tshirts[item].id} className="m-4 md:m-0">
                <Link href={`/product/${tshirts[item].id}`}>
                  <img
                    alt="ecommerce"
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-1 ">
                    {tshirts[item].size.map((k) => {
                      return (
                        <div
                          className="inline-block border rounded-md border-gray-200 px-1 mx-1 mt-2 text-sm"
                          key={k}
                        >
                          {k}
                        </div>
