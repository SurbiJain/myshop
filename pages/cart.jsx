  ...
  return (
    <section class="bg-white p-6 main md:py-16">
      <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <h2 class="text-xl font-semibold text-gray-900e sm:text-2xl">
          Shopping Cart
        </h2>
            ...
            <div class="space-y-6">
              {cartQuantity === 0 ? (
                ...
                cart.map((item) => {
                  return (
                    <div
                      class="rounded-lg border border-gray-200 bg-white p-4 shadow-smmd:p-6"
                      key={item.itemCode}
                    >
                        ...
                        <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                          ...
                          <div class="flex items-center gap-4">
                            <button
                              ...
                              onClick={() => {
                                dispatch(clearItem(item.itemCode));
                              }}
                            >
                              <svg
