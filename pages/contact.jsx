...
const Contact = () => {
  return (
    <section class="bg-white main container mx-auto p-6">
      <div>
      ...
      <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <p class="mt-2 text-blue-500 ">myShop@gmail.com</p>
        </div>
        ...
        <div>
          ...
          <p class="mt-2 text-gray-500 ">Come say hello at our shop.</p>
        ...
        <div>
          ...
          <p class="mt-2 text-blue-500 ">+91 000-000-0000</p>
        </div>
      </div>
    </section>
  );
